...
for(double i=10.5;i<65;i+=1.5){
	cutg->SetPoint(0, i, -3);
	cutg->SetPoint(1, i+10.5, -3);
	cutg->SetPoint(2, i+10.5, 4.5);
	cutg->SetPoint(3, i, 4.5);

	cutg1->SetPoint(0, -i, -4.5);
	cutg1->SetPoint(1, -i-10.5, -4.5);
	cutg1->SetPoint(2, -i-10.5, 3);
	cutg1->SetPoint(3, -i, 3);

	cutg2->SetPoint(0, -4.5, i);
	cutg2->SetPoint(1, 6.5, i);
	cutg2->SetPoint(2, 6.5, i+10.5);
	cutg2->SetPoint(3, -4.5, i+10.5);

	cutg3->SetPoint(0, -6.5, -i);
	cutg3->SetPoint(1, 4.5, -i);
	cutg3->SetPoint(2, 4.5, -i-10.5);
	cutg3->SetPoint(3, -6.5, -i-10.5);
	sprintf(buf, "h%i", i);	
